...
if(document.length >= 5){  $('.tldr-output').text(sents[0] + "" + document[1].sentence + "" + document[2].sentence + "" + document[3].sentence + "" + document[4].sentence);
$( ".tldr-output" ).prepend( "<h4>tl;dr</h4>" );
}
else
  $(".tldr-output").text("");
})